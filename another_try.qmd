...
college_request <- request("https://api.data.gov") %>% 
  ...
  req_url_query(
    ...
    fields = "id,school.name,school.ownership,latest.student.size,school.state,latest.cost.tuition.in_state,latest.cost.tuition.out_of_state,latest.admissions.admission_rate.overall,latest.cost.attendance.academic_year,latest.completion.completion_rate_4yr_150nt,latest.repayment.2_yr_bb_fed_repayment.ugcomp.fullypaid,latest.earnings.1_yr_after_completion.median,latest.earnings.5_yrs_after_completion.median" ,
    per_page = 100,
    page = k,
  )
